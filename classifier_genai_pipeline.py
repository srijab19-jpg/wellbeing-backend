...
def generate_synthetic_dataset(n=600, seed=RANDOM_STATE):
    ...
    attendance_pct = rng.integers(30, 101, n)  # % classes attended, past 4wks
    missed_deadlines = rng.integers(0, 6, n)  # count, past 4wks
    weekly_study_hours = rng.integers(0, 41, n)  # self-reported hrs/week
    ...
    burnout_score = (
        ...
        + 0.05 * ((100 - attendance_pct) / 10)
        - 0.03 * (weekly_study_hours / 5)
    )
